...
// Fetch: an API that allows us to do AJAX calls which returns a Promise
...
// For the sake of us using Fetch, it will just return a Promise object for us that we can use
...
class App extends Component {
  ...
  //     // after we use json() we can THEN use .then() to do the next task
  //     .then(data => console.log(data))
  // }

  // THIRD PARTY API - Google, Twitter...companies provide APIs which allows us access to their data. A lot of FREE APIs and some require API keys.
